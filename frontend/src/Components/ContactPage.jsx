      ...
      <div className="w-full md:w-1/2 flex flex-col">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md flex-grow">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button
              type="submit"
              className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-black hover:bg-black-500 focus:ring-4 focus:outline-none focus:ring-blue-300 w-full transition duration-300 ease-in-out"
            >
